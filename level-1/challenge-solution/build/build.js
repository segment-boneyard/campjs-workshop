...
require.register("segmentio~on-body@0.0.1", function (exports, module) {
var each = require("component~each@0.2.2");
...
require.register("component~notification@0.0.5", function (exports, module) {

/**
 * Module dependencies.
 */

var dom = require("component~dom@1.0.5");
var Emitter = require("component~emitter@1.0.1");
var onBody = require("segmentio~on-body@0.0.1");
...
function Notification(options) {
  Emitter.call(this);
  options = options || {};
  this.el = dom(require("component~notification@0.0.5/template.js"));
  this.render(options);
...
require.register("component~notification@0.0.5/template.js", function (exports, module) {
...
var notify = require("component~notification@0.0.5");
